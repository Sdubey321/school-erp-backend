...
-- CreateIndex
CREATE UNIQUE INDEX "salary_slips_salaryRecordId_key" ON "salary_slips"("salaryRecordId");

-- CreateIndex
CREATE UNIQUE INDEX "salary_slips_slipNo_key" ON "salary_slips"("slipNo");

-- CreateIndex
CREATE UNIQUE INDEX "hall_tickets_studentId_examTypeId_key" ON "hall_tickets"("studentId", "examTypeId");

-- CreateIndex
CREATE UNIQUE INDEX "exam_attendances_studentId_examTypeId_subjectId_key" ON "exam_attendances"("studentId", "examTypeId", "subjectId");
...
-- AddForeignKey
ALTER TABLE "salary_records" ADD CONSTRAINT "salary_records_teacherId_fkey" FOREIGN KEY ("teacherId") REFERENCES "teachers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "salary_slips" ADD CONSTRAINT "salary_slips_salaryRecordId_fkey" FOREIGN KEY ("salaryRecordId") REFERENCES "salary_records"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "hall_tickets" ADD CONSTRAINT "hall_tickets_examTypeId_fkey" FOREIGN KEY ("examTypeId") REFERENCES "exam_types"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "exam_attendances" ADD CONSTRAINT "exam_attendances_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "students"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "exam_attendances" ADD CONSTRAINT "exam_attendances_examTypeId_fkey" FOREIGN KEY ("examTypeId") REFERENCES "exam_types"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "exam_attendances" ADD CONSTRAINT "exam_attendances_subjectId_fkey" FOREIGN KEY ("subjectId") REFERENCES "subjects"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "marksheet_templates" ADD CONSTRAINT "marksheet_templates_schoolId_fkey" FOREIGN KEY ("schoolId") REFERENCES "schools"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
